...
Public Property Let CheckDownColor(nColor As OLE_COLOR)

' Changes the text color when mouse is over the button
' Changing this property will affect the type of HoverLock

If myProps.bForeDown = nColor Then Exit Property
myProps.bForeDown = nColor
PropertyChanged "cFDown"
'If nColor <> UserControl.ForeColor Then
'    If myProps.bLockHover = lv_LockTextandBackColor Then
'        myProps.bLockHover = lv_LockBackColorOnly
'    Else
...
PropertyChanged "cFDown"
End Property
Public Property Get CheckDownColor() As OLE_COLOR
CheckDownColor = myProps.bForeDown
End Property
    ...
    Else
        'DrawRect ButtonDC.hDC, 0, 0, ScaleWidth, ScaleHeight, bColor2Use
            If UserControl.Enabled = True Then
                DrawRect ButtonDC.hDC, 0, 0, ScaleWidth, ScaleHeight, bColor2Use
            Else
                DrawRect ButtonDC.hDC, 0, 0, ScaleWidth, ScaleHeight, RGB(30, 30, 30)
            End If
    End If
End If
...
With PropBag
    ...
    myProps.bForeDown = .ReadProperty("cFDown", vbButtonText)
...
With PropBag
    ...
    .WriteProperty "cFDown", myProps.bForeDown, vbButtonText
